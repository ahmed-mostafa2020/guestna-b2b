...
export default function Page() {
  ...
  const renderStatusMessage = () => {
    // Render placeholder until client-side check is complete
    ...
    <>
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            href="https://any-2y.sentry.io/issues/?project=4510176638599168"
          >
            Issues Page
          </a>
        ...
        <div suppressHydrationWarning>{renderStatusMessage()}</div>
