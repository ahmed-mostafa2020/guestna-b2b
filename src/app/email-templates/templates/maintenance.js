    ...
    <tr>
      <td align="center" style="padding:32px 16px;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="main-table"
          ...
          <!-- Header -->
          <tr>
            <td style="background:linear-gradient(150deg,#1a1a2e 0%,#16213e 60%,#0f3460 100%);padding:40px 36px 36px;text-align:center;">
              ...
              <div style="font-size:24px;font-weight:700;color:#ffffff;margin-bottom:8px;line-height:1.3;">صيانة مجدولة للنظام</div>
          ...
          <tr>
            <td class="content-pad" style="padding:0 36px 24px;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #E2E8F0;border-radius:14px;overflow:hidden;">
                ...
                <tr>
                  <td style="padding:16px 20px;width:45%;border-bottom:1px solid #F1F5F9;background:#F8FAFC;">
                ...
                <tr>
                  <td style="padding:16px 20px;width:45%;background:#F8FAFC;">
