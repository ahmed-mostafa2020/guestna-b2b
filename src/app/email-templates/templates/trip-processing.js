// Ref: email-temp/admin/processingAskTrip.ts
export const tripProcessingHTML = `<!DOCTYPE html>
<html lang="ar" dir="rtl">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <title>تحديث حالة الطلب - GuestNa</title>
  <style>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="main-table" style="max-width:600px;background-color:#ffffff;border-radius:20px;overflow:hidden;margin:0 auto;box-shadow:0 8px 40px rgba(10,37,64,0.12);">
          ...
          <tr>
            <td class="header-pad" style="background:linear-gradient(150deg,#0A2540 0%,#006e6e 60%,#008F8F 100%);padding:36px 36px 32px;text-align:center;">
              ...
              <div style="display:inline-block;background:rgba(255,255,255,0.15);border:1px solid rgba(255,255,255,0.3);border-radius:50px;padding:5px 18px;font-size:11px;color:#fff;letter-spacing:1.5px;text-transform:uppercase;margin-bottom:16px;">Trip Status</div>
              <div class="mobile-h1" style="font-size:24px;font-weight:700;color:#ffffff;margin-bottom:8px;line-height:1.3;">📋 الطلب قيد المعالجة</div>
              <div style="font-size:14px;color:rgba(255,255,255,0.6);">طلبك قيد مراجعة واعتماد الشركة</div>
            </td>
          </tr>

          <!-- Blue Accent Line -->
          <tr>
            <td style="height:4px;background:linear-gradient(90deg,#3B82F6,#2563EB,#3B82F6);"></td>
          </tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom:24px;">
                <tr>
                  <td style="background:#EFF6FF;border-right:4px solid #3B82F6;border-radius:10px 0 0 10px;padding:16px 20px;text-align:right;">
                    <div style="font-size:12px;font-weight:700;color:#2563EB;margin-bottom:6px;">حالة الطلب: قيد الاعتماد</div>
                    <div style="font-size:14px;color:#1E40AF;line-height:1.7;">
                      تم استلام طلب الرحلة الخاص بك والموافقة عليه مبدئياً، وهو الآن قيد الاعتماد النهائي من قبل إدارة عمليات الشركة. سيتم إرسال التأكيد النهائي قريباً.
                    </div>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #E2E8F0;border-radius:14px;overflow:hidden;margin-bottom:24px;">
                <tr>
                  <td colspan="2" style="width:42%;background:#F8FAFC;border-bottom:1px solid #E2E8F0;padding:12px 20px;text-align:right;">
                    <span style="font-size:12px;font-weight:700;color:#64748B;text-transform:uppercase;letter-spacing:0.8px;">مراجعة بيانات الطلب</span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding:14px 20px 6px;border-bottom:1px solid #F1F5F9;text-align:right;">
                    <div style="font-size:15px;color:#1E293B;font-weight:700;">#REQ-2025-0211</div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding:10px 20px 6px;border-bottom:1px solid #F1F5F9;text-align:right;">
                    <div style="font-size:15px;color:#008F8F;font-weight:600;">مدرسة الأفق العلمي — جدة</div>
                  </td>
                </tr>
                <tr>
                  <td style="width:42%;padding:10px 20px 14px;text-align:right;">
                    <div style="font-size:11px;text-transform:uppercase;letter-spacing:0.6px;color:#94A3B8;font-weight:600;">تاريخ آخر تحديث</div>
                  </td>
                  <td style="padding:10px 20px 14px;text-align:right;">
                    <div style="font-size:15px;color:#1E293B;font-weight:600;">السبت، 12 أبريل 2025</div>
                  </td>
                </tr>
              </table>
