        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="main-table" style="max-width:600px;background-color:#ffffff;border-radius:20px;overflow:hidden;margin:0 auto;box-shadow:0 8px 40px rgba(10,37,64,0.12);">
          ...
          <tr>
            <td class="content-pad" style="padding:32px 36px;">
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom:24px;">
                <tr>
                  <td align="center">
                    <div style="display:inline-block;background:linear-gradient(135deg,#ED8A2215,#ED8A2208);border:2px solid #ED8A2230;border-radius:14px;padding:20px 40px;text-align:center;">
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #E2E8F0;border-radius:14px;overflow:hidden;margin-bottom:24px;">
                <tr>
                  <td colspan="2" style="background:#0A2540;border-bottom:1px solid #E2E8F0;padding:12px 20px;text-align:right;">
          ...
          <tr>
            <td style="background:#0A2540;padding:24px 36px;text-align:center;">
              ...
              <p style="margin:0 0 8px;font-size:12px;color:rgba(255,255,255,0.35);">هذا البريد تلقائي — للتواصل: <a href="mailto:finance@guestna-edu.com" style="color:rgba(255,255,255,0.55);text-decoration:none;">finance@guestna-edu.com</a></p>
