            ...
            <td class="content-pad" style="padding:0 36px 24px;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #E2E8F0;border-radius:14px;overflow:hidden;">
                ...
                <tr>
                  ...
                  <td style="padding:14px 20px 6px;border-bottom:1px solid #F1F5F9;text-align:right;">
                    <div style="font-size:15px;font-weight:700;">
                      <a href="https://guestna-b2b.vercel.app/ar/parents/camping-adventure-girls-sdfsdf-st-186" style="color:#008F8F;text-decoration:none;border-bottom:1px dashed #008F8F;">رحلة المزرعة التعليمية — الرياض ↗</a>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding:10px 20px 6px;border-bottom:1px solid #F1F5F9;text-align:right;">
                    <div style="font-size:15px;color:#1E293B;font-weight:600;">2 طالبا</div>
                  </td>
                </tr>
                <tr>
                  <td style="width:42%;padding:10px 20px 6px;border-bottom:1px solid #F1F5F9;text-align:right;">
                  ...
                  <td style="padding:10px 20px 6px;border-bottom:1px solid #F1F5F9;text-align:right;">
                    <div style="font-size:15px;color:#1E293B;font-weight:600;">أحمد محمد - سارة علي</div>
                  </td>
                </tr>
                <tr>
          ...
          <tr>
            <td class="content-pad" style="padding:0 36px 24px;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #E2E8F0;border-radius:14px;overflow:hidden;">
                ...
                <tr>
                  <td style="padding:14px 20px;width:42%;border-bottom:1px solid #F1F5F9;text-align:right;">
                    <div style="font-size:13px;color:#475569;font-weight:600;">المجموع</div>
                  </td>
                  <td style="padding:14px 20px;border-bottom:1px solid #F1F5F9;text-align:left;">
                    <div style="font-size:14px;color:#1E293B;font-weight:600;font-family:monospace;">1,500.00 ر.س</div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding:12px 20px;border-bottom:1px solid #F1F5F9;text-align:left;">
                    <div style="font-size:14px;color:#1E293B;font-weight:600;font-family:monospace;">225.00 ر.س</div>
                  </td>
                </tr>
                <tr>
                  <td style="width:42%;padding:12px 20px;border-bottom:1px solid #F1F5F9;text-align:right;">
                ...
                <tr>
                  ...
                  <td style="padding:14px 20px;background:#F0FDFA;text-align:left;">
                    <div style="font-size:16px;color:#008F8F;font-weight:800;font-family:monospace;">1,725.00 ر.س</div>
                  </td>
                </tr>
              </table>
            </td>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background:#FFF8F0;border-left:4px solid #ED8A22;border-radius:0 10px 10px 0;">
                <tr>
                  <td style="padding:16px 20px;text-align:right;">
                    <a href="#" style="font-size:12px;font-weight:700;color:#ED8A22;text-transform:uppercase;letter-spacing:0.6px;margin-bottom:6px;text-decoration:none;">📍 نقطة التجمع</a>
