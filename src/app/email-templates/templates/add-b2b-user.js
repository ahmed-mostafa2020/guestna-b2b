        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="main-table" style="max-width:600px;background-color:#ffffff;border-radius:20px;overflow:hidden;margin:0 auto;box-shadow:0 8px 40px rgba(10,37,64,0.12);">
          ...
          <tr>
            <td class="content-pad" style="padding:32px 36px;">
              ...
              <p class="mobile-h2" style="font-size:20px;color:#008F8F;font-weight:700;text-align:center;margin:0 0 16px;">🎊 تهانينا، أ. أحمد مصطفى!</p>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom:24px;background:#FFFBEB;border:2px dashed #F59E0B;border-radius:12px;">
                <tr>
                  <td align="center" style="padding:20px;">
                    ...
                    <div class="mobile-pwd" style="background:#ffffff;border:1px solid #FCD34D;color:#1E293B;font-size:22px;font-weight:700;padding:12px 24px;border-radius:8px;font-family:monospace;letter-spacing:3px;display:inline-block;margin-bottom:10px;" dir="ltr">TempPass#2025</div>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td align="center" style="padding-top:10px;">
                    <a class="mobile-btn" href="https://guestna-b2b.vercel.app/ar/login" style="display:inline-block;background:linear-gradient(135deg,#008F8F,#006e6e);color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;padding:15px 44px;border-radius:10px;box-shadow:0 4px 20px rgba(0,143,143,0.3);">
          ...
          <tr>
            <td class="footer-pad" style="background:#0A2540;padding:28px 36px;text-align:center;">
              ...
              <p style="margin:0 0 6px;font-size:13px;color:rgba(255,255,255,0.7);font-weight:600;"></p>
