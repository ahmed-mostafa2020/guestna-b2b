...
<head>
  ...
  <base target="_blank" />
  <title>Wallet Withdrawal Request - GuestNa</title>
  <style>
          ...
          <tr>
            <td class="header-pad" style="background:linear-gradient(150deg,#0A2540 0%,#006e6e 60%,#008F8F 100%);padding:36px 36px 32px;text-align:center;">
              ...
              <div style="font-size:14px;color:rgba(255,255,255,0.6);">
                A new withdrawal request awaiting review
              </div>
            </td>
          </tr>
            ...
            <td class="content-pad" style="padding:32px 36px;">
                ...
                <tr>
                  <td style="background:#FFF8F0;border-left:4px solid #ED8A22;border-radius:0 10px 10px 0;padding:16px 20px;text-align:left;">
                    <div style="font-size:13px;color:#92400E;font-weight:600;line-height:1.6;">
                      A new wallet withdrawal request has been received through the dashboard. Please review the details below and process it per the approved withdrawal policy.
                    </div>
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td align="center">
                    <div class="mobile-amount" style="display:inline-block;background:linear-gradient(135deg,#ED8A2215,#ED8A2208);border:2px solid #ED8A2230;border-radius:14px;padding:20px 40px;text-align:center;">
                      <div style="font-size:11px;text-transform:uppercase;letter-spacing:1px;color:#ED8A22;font-weight:700;margin-bottom:6px;">Withdrawal Amount</div>
                      <div style="font-size:30px;font-weight:700;color:#ED8A22;">SAR 8,200.00</div>
                      <div style="margin-top:8px;">
                        <span style="display:inline-block;background:#F59E0B;color:#fff;font-size:12px;font-weight:700;padding:4px 14px;border-radius:50px;">⏳ Pending Review</span>
                      </div>
                    </div>
                  </td>
                </tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #E2E8F0;border-radius:14px;overflow:hidden;margin-bottom:24px;">
                ...
                <tr>
                  ...
                  <td style="padding:10px 20px 6px;border-bottom:1px solid #F1F5F9;text-align:left;">
                    <div style="font-size:15px;color:#1E293B;font-weight:600;">#GN-2025-4521 — Educational Farm Trip</div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding:10px 20px 14px;text-align:left;">
                    <div style="font-size:15px;color:#1E293B;font-weight:600;">🏦 Bank Transfer — Al Rajhi Bank</div>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #E2E8F0;border-radius:14px;overflow:hidden;margin-bottom:24px;">
                ...
                <tr>
                  <td style="padding:14px 20px;width:55%;border-bottom:1px solid #F1F5F9;text-align:left;">
                    <div style="font-size:13px;color:#64748B;">Balance Before Withdrawal</div>
                  </td>
                  <td style="padding:14px 20px;border-bottom:1px solid #F1F5F9;text-align:left;">
                    <div style="font-size:15px;color:#1E293B;font-weight:600;">SAR 12,500.00</div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding:14px 20px;border-bottom:1px solid #F1F5F9;background:#FFF8F0;text-align:left;">
                    <div style="font-size:18px;color:#ED8A22;font-weight:700;">SAR 8,200.00</div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding:14px 20px;background:#F0FDFA;text-align:left;">
                    <div style="font-size:18px;color:#008F8F;font-weight:700;">SAR 4,300.00</div>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom:24px;">
                <tr>
                  <td style="background:#FFFBEB;border-left:4px solid #F59E0B;border-radius:0 10px 10px 0;padding:16px 20px;text-align:left;">
                    <div style="font-size:13px;color:#92400E;font-weight:600;line-height:1.6;">
                      Please verify all payment details before processing. Contact the school if any information is incorrect or missing.
                    </div>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td align="center" style="padding-top:8px;">
                    <a href="https://guestna-revamp-dashboard.vercel.app/b2b/withDrawals" target="_blank" class="mobile-btn"
