...
const OrderDetailsPage = ({ params }) => {
  ...
  return (
    ...
    >
      {paramsLoading ? (
        <FullScreenLoading status />
      ) : loadingEditDetails && !currentEditOrderDetails ? (
        <OrderPageLoadingSkeleton />
      ) : error && !currentEditOrderDetails ? (
        <Box p={3}>
        ...
        <Box className="!font-somar py-3 mx-auto">
          ...
          <Stack spacing={4}>
            <div ref={schoolRef}>
              <SchoolMainInfoCard orderData={currentEditOrderDetails} />
            </div>

            <div ref={tripRef}>
              <TripInfoCard orderData={currentEditOrderDetails} />
            </div>

            <div ref={dateRef}>
              <TripDateCard orderData={currentEditOrderDetails} />
            </div>

            <div ref={pricingRef}>
              <PricingInfoCard orderData={currentEditOrderDetails} />
            </div>

            <div ref={additionalRef}>
              <AdditionalInfoCard orderData={currentEditOrderDetails} />
            </div>
          </Stack>
