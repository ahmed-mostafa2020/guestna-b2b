...
const AITrainingAppleWidget = ({ baseData }) => {
  ...
  useEffect(() => {
    Moyasar.init({
      element: ".ai-camp-mysr-form",
      amount: CAMP_FEE * 100,
      language: locale,
      currency: "SAR",
      description: "AI Training Camp Registration",
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="ai-camp-mysr-form"></div>
    </div>
  );
};

export default memo(AITrainingAppleWidget);
