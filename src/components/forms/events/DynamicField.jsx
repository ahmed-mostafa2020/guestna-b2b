  ...
  return (
    <>
      ...
      >
        ...
        />
        <div className="absolute inset-0 flex items-center justify-center opacity-100 sm:opacity-0 group-hover:opacity-100 bg-black/40 rounded-lg transition-opacity duration-200">
          <svg
                ...
                >
                  {opt.src ? (
                    <div
                      ...
                      aria-label={t ? t("common.viewLargerImage") : "View larger image"}
                      title={t ? t("common.viewLargerImage") : "View larger image"}
