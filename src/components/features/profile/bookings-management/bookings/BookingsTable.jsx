...
const BookingsTable = ({
  ...
  const hasActions = hasElement(
    PERMISSIONS.ELEMENT.B2B_PROFILE_BOOKINGS_SHOW_TRIP_DETAILS_BUTTON
  );
  ...
  return (
    <DataTable
      ...
      actionsLabel={
        hasActions ? t("profile.tables.bookings.header.actions") : ""
      }
      rowActions={
        hasActions ? (row) => <ActionsDropdownMenu booking={row} /> : undefined
      }
      pagination={
