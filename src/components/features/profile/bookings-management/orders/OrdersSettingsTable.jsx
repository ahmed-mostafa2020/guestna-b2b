...
const getStatusInfo = (tripsCount, maximumNumberTrips, t) => {
  ...
  if (remaining <= 0) {
    return {
      ...
      className: "px-4 py-2 rounded-[45px] bg-status-success-bg text-status-success-fg",
    };
  }
  ...
  return {
    label: tripWord,
    className: "px-4 py-2 rounded-[45px] bg-status-warning-bg text-status-warning-fg",
  };
};
