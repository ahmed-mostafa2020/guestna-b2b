...
const getStatusInfo = (tripsCount, maximumNumberTrips, t) => {
  ...
  if (remaining <= 0) {
    return {
      ...
      className:
        "px-4 py-2 rounded-[45px] bg-status-success-bg text-status-success-fg",
    };
  }
  ...
  return {
    label: tripWord,
    className:
      "px-4 py-2 rounded-[45px] bg-status-warning-bg text-status-warning-fg",
  };
};
...
const OrdersSettingsTable = () => {
    ...
    () => [
      {
        ...
        render: (row) => (
          <div className="truncate" title={row.organization?.name}>
  ...
  return (
    <div className="flex flex-col w-full bg-white rounded-2xl py-4 px-3 shadow-card">
      {/* Header */}
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-2 lg:mb-8">
        <div className="flex justify-between items-center w-full flex-wrap">
          <h2 className="text-lg font-medium lg:text-2xl !mb-2 !lg:mb-8 text-mainColor">
