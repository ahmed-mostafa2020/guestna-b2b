...
import FavoriteButton from "@components/common/trips/FavoriteButton";
...
const GalleryHeader = ({ tripData }) => {
  ...
  return (
    <>
      <h1 className="text-xl font-semibold lg:text-5xl">{tripData?.name}</h1>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          <FavoriteButton
            favoriteState={tripData?.isFavorite}
            tripId={tripData?._id}
            withText={true}
          />
