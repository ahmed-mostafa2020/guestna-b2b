 ...
 * @returns {string} Formatted 24-hour time string "HH:mm" or empty string
 */
export const formatTimeForInput = (timeStr) => {
  ...
  // 1. If in 12-hour format with AM/PM (e.g., "08:00AM", "8:00 AM", "02:30PM", "2:30 PM", "8AM", "2PM", "08:00:00 AM")
  ...
  // 2. If in HH:mm or HH:mm:ss 24-hour format (e.g., "08:00", "14:30", "8:00")
