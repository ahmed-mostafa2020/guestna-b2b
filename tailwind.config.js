  ...
  theme: {
    extend: {
      colors: {
        ...
        secColor: "rgb(var(--color-secondary)/<alpha-value>)",
        titleColor: "rgb(var(--color-title)/<alpha-value>)",
        textDark: "rgb(var(--color-text-dark)/<alpha-value>)",
        textLight: "rgb(var(--color-text-light)/<alpha-value>)",
        homeBg: "rgb(var(--color-bg-home)/<alpha-value>)",
        packageDetailsBg: "rgb(var(--color-bg-package-details)/<alpha-value>)",
        activityDetailsBg: "var(--color-bg-activity-details)",
        linksHover: "var(--color-links-hover)",
        buttonsHover: "rgb(var(--color-buttons-hover)/<alpha-value>)",
        ...
        footerLink: "rgb(var(--color-footer-link)/<alpha-value>)",
